...
export const NPCS: Npc[] = [
  ...
  // --- Frozen Frontier (MSQ Volume VI), Chapter 11: Into the Endless Winter ---
  {
    id: 'elder-henrik',
    name: 'Elder Henrik',
    title: 'Elder of Frosthaven',
    spriteAssetId: 'sprite.npc.elder-henrik',
    portraitAssetId: 'portrait.elder-henrik',
    locationId: 'frosthaven-explorer-headquarters',
    dialogue: [
  ...
  },
  {
    ...
    name: 'Captain Astrid Frost',
    title: 'Frontier Captain',
    spriteAssetId: 'sprite.npc.captain-astrid-frost',
    portraitAssetId: 'portrait.captain-astrid-frost',
    locationId: 'frosthaven',
    dialogue: [
  ...
  },
  {
    ...
    name: 'Aurora Keeper Lyra',
    title: 'Keeper of the Ice Chapel',
    spriteAssetId: 'sprite.npc.aurora-keeper-lyra',
    portraitAssetId: 'portrait.aurora-keeper-lyra',
    locationId: 'frosthaven-ice-chapel',
    dialogue: [
  ...
  },
  {
    id: 'winter-spirit',
    name: 'Winter Spirit',
    title: 'Voice of Aurora Basin',
    spriteAssetId: 'sprite.npc.winter-spirit',
    portraitAssetId: 'portrait.winter-spirit',
    locationId: 'aurora-basin',
    dialogue: [
      { speaker: 'Winter Spirit', text: '...small and warm, the way that light used to be before mine went out entirely. Word of you crossed the frontier faster than any storm.' },
  ...
  },
  {
    ...
    name: 'Greta',
    title: 'Innkeeper',
    spriteAssetId: 'sprite.npc.innkeeper-greta',
    portraitAssetId: 'portrait.innkeeper-greta',
    locationId: 'frosthaven-inn',
    dialogue: [
      { speaker: 'Greta', text: "Keep the fires going day and night up here - let one go out and it takes half a day to get the room warm again." },
      { speaker: 'Greta', text: 'Rest up, Keeper. The frontier keeps its own kind of cold, and it does not care how prepared you think you are.' },
    ],
    gameplayHook: { type: 'inn', innId: 'greta-inn' },
  },
  {
    id: 'storekeeper-bjorn',
    name: 'Bjorn',
    title: 'General Store Owner',
    spriteAssetId: 'sprite.npc.storekeeper-bjorn',
    portraitAssetId: 'portrait.storekeeper-bjorn',
    locationId: 'frosthaven-general-store',
    dialogue: [
      { speaker: 'Bjorn', text: "Supply runs from the south have gotten thinner every season. Half of what's on these shelves I traded for, not bought." },
      { speaker: 'Bjorn', text: 'Thaw crystals, lantern oil, the essentials. Ask if you need something particular for the cold.' },
    ],
    gameplayHook: { type: 'shop', shopId: 'bjorn-general-store' },
  },
  {
    id: 'blacksmith-sigrid',
    name: 'Sigrid',
    title: 'Blacksmith',
    spriteAssetId: 'sprite.npc.blacksmith-sigrid',
    portraitAssetId: 'portrait.blacksmith-sigrid',
    locationId: 'frosthaven-blacksmith',
    dialogue: [
      { speaker: 'Sigrid', text: "Steel that cracks in the cold is steel that was never tempered right. I quench slow, up here - takes twice as long, but it holds." },
      { speaker: 'Sigrid', text: 'Pikes, mostly - reach matters more than speed when the ice gives you exactly one good step before it decides otherwise. Have a look.' },
    ],
    gameplayHook: { type: 'shop', shopId: 'sigrid-forge' },
  },
  {
    id: 'armorer-magnus',
    name: 'Magnus',
    title: 'Armorer',
    spriteAssetId: 'sprite.npc.armorer-magnus',
    portraitAssetId: 'portrait.armorer-magnus',
    locationId: 'frosthaven-armory',
    dialogue: [
      { speaker: 'Magnus', text: "Fur over plate, always. Metal alone out here will draw the cold straight into you faster than any wound would." },
      { speaker: 'Magnus', text: 'Coats, leggings, boots, gloves - all lined heavy. Have a look before you head back out.' },
    ],
    gameplayHook: { type: 'shop', shopId: 'magnus-armory' },
  },
];
