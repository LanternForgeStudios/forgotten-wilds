...
export const ITEMS: Item[] = [
  ...
  {
    id: 'prairie-charm-relic',
    name: 'Wind-Worn Relic',
    description: 'A relic carved by hands long gone, humming with a spirit-craft older than the Winter Counts - tucked into Stone Circle Valley.',
    category: 'keyItem',
    iconAssetId: 'icon.item.winter-count-hide-i',
    stackable: false,
    tier: 'rare',
  ...
  {
    id: 'prairie-totem-relic',
    name: 'Herd-Bound Relic',
    description: "A second relic, its carving shaped like a running herd - found half-buried in Golden Prairie's grass.",
    category: 'keyItem',
    iconAssetId: 'icon.item.winter-count-hide-ii',
    stackable: false,
    tier: 'rare',
  ...
  {
    id: 'cedar-charm-relic',
    name: 'Cedar-Carved Relic',
    description: 'A relic carved from ancient cedar wood, humming with a spirit-craft older than the Heartwood Recordings - found in Elder Forest.',
    category: 'keyItem',
    iconAssetId: 'icon.item.heartwood-recording',
    stackable: false,
    tier: 'rare',
  ...
  {
    id: 'cedar-totem-relic',
    name: 'River-Bound Relic',
    description: 'A second cedar-carved relic, its pattern shaped like flowing water - found among the roots of Silver River.',
    category: 'keyItem',
    iconAssetId: 'icon.item.heartwood-recording',
    stackable: false,
    tier: 'rare',
  ...
  {
    id: 'desert-charm-relic',
    name: 'Sun-Worn Relic',
    description: 'A relic weathered smooth by desert wind and sun, humming with a spirit-craft older than the Desert Relics - found in Crimson Canyons.',
    category: 'keyItem',
    iconAssetId: 'icon.item.desert-relic',
    stackable: false,
    tier: 'rare',
  ...
  {
    id: 'desert-totem-relic',
    name: 'Star-Marked Relic',
    description: 'A second sun-worn relic, its surface etched with star-patterns - found among the painted stone of Painted Mesas.',
    category: 'keyItem',
    iconAssetId: 'icon.item.desert-relic',
    stackable: false,
    tier: 'rare',
  ...
  },
  {
    id: 'starlight-dust',
    name: 'Starlight Dust',
    description: 'A pinch of pale dust, stripped from a celestial wisp, faintly glowing even in daylight.',
    category: 'materials',
    iconAssetId: 'icon.item.starlight-dust',
    stackable: true,
    tier: 'common',
  },
  {
    id: 'canyon-giant-core',
    name: 'Canyon Giant Core',
    description: "A fragment of the Canyon Giant's own stone heart, still faintly warm with old spirit-light.",
    category: 'keyItem',
    iconAssetId: 'icon.item.canyon-giant-core',
    stackable: false,
    tier: 'legendary',
    unique: true,
  },
...
export const SHOP_TITLES: Record<string, string> = {
  ...
  'byron-general-store': "Cedarwatch's General Store",
  'dara-forge': 'The Cedarwatch Forge',
  'fenn-armory': 'The Cedarwatch Armory',
  'mateo-general-store': "Red Mesa's General Store",
  'esteban-forge': 'The Red Mesa Forge',
  'carmen-armory': 'The Red Mesa Armory',
