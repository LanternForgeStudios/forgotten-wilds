...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    objectives: [
      ...
      { id: 'talk-cedar-spirit-meet', type: 'talkToNpc', description: 'Meet the Cedar Spirit.', targetId: 'cedar-spirit', requiredCount: 1 },
    ],
  ...
  },
  {
    ...
    objectives: [
      ...
      { id: 'talk-elowen-report', type: 'talkToNpc', description: 'Bring the records to Archivist Elowen.', targetId: 'archivist-elowen', requiredCount: 1 },
    ],
