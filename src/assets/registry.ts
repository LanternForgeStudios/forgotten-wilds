...
export const ASSET_REGISTRY: AssetDefinition[] = [
  ...
  {
    id: 'tileset.whispering-pines-terrain',
    category: 'tileset',
    intendedUse:
      "Whispering Pines field terrain (Mistwood Path, Elder Forest, Silver River, Ancient Cedar Shrine, Heartwood Approach) - a 4x4 Wang autotile set (16x16 tiles) transitioning packed dirt forest path to mossy forest ground, replacing the generic tileset.overworld-terrain those 5 field maps used at ship time. Same numeric fill/transition tile ids as every other region's own Wang terrain set (a fixed convention of this project's create_topdown_tileset pipeline - grid position is determined by corner pattern, not per-generation), so swapping the tileset reference in each map's scripts/map-specs-richer/*.json spec and regenerating via genMapRicher.mjs required no id remapping.",
    filePath: 'tilesets/whispering-pines-terrain.png',
    dimensions: { width: 64, height: 64 },
    status: 'final',
    notes:
      'pixellab MCP-generated via create_topdown_tileset (standard mode, 16x16, high top-down view; lower="soft mossy forest ground, deep green moss with small mushrooms and fallen leaves", upper="packed dirt forest path, worn earth with scattered roots and pine needles", transition_size=0.5, transition="moss thinning into bare packed dirt at the path\'s edge"). Ready 4x4 grid PNG, used as-is. Build script: scripts/build_tilesets.py.',
  },
  {
  ...
  {
    id: 'tileset.frosthaven-terrain',
    category: 'tileset',
    intendedUse:
      "Frosthaven/Frozen Frontier ground terrain - a 4x4 Wang autotile set (16x16 tiles) transitioning packed snow with a worn icy trail to deep untouched snowdrift, the region's primary field terrain (distinct from the generic overworld-terrain, which has no snow palette at all).",
    filePath: 'tilesets/frosthaven-terrain.png',
    dimensions: { width: 64, height: 64 },
    status: 'final',
    notes:
  ...
  {
    id: 'tileset.pixel-16-woods',
    category: 'tileset',
    intendedUse: 'Forest/woods terrain and decor tileset (16x16) - not yet wired into any map',
    filePath: 'tilesets/free_pixel_16_woods.png',
    dimensions: { width: 352, height: 192 },
    status: 'placeholder',
    notes: 'provenance unconfirmed, verify license before shipping as final. 22x12 grid of 16x16 tiles.',
  },
  {
    id: 'tileset.rpg-icons',
    category: 'tileset',
    intendedUse: 'RPG icon sheet (helms, armor, weapons, potions, gems, rings, chests) - not yet wired into any map',
    filePath: 'tilesets/rpg-icons.jpg',
    dimensions: { width: 188, height: 171 },
    status: 'placeholder',
    notes: 'provenance unconfirmed, verify license before shipping as final. Grid layout not yet visually confirmed - inspect in Tiled before slicing precise tile size.',
  },
  {
